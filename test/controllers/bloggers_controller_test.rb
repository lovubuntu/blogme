...
class BloggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogger" do
    assert_difference('Blogger.count') do
      post bloggers_url, params: { blogger: { content: @blogger.content, days: @blogger.days, name: @blogger.name } }
    end
  ...
  test "should update blogger" do
    patch blogger_url(@blogger), params: { blogger: { content: @blogger.content, days: @blogger.days, name: @blogger.name } }
